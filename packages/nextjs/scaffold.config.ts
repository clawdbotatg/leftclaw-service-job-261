...
const scaffoldConfig = {
  ...
  rpcOverrides: {
    [chains.base.id]: process.env.NEXT_PUBLIC_ALCHEMY_RPC_URL || `https://base-mainnet.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ALCHEMY_API_KEY || "IZYEU2cWBgnFmgiTAgpWD"}`,
  },
